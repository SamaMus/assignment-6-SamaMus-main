...
public class GraphTesting {
  ...
  public static <T> boolean isIterableEqualTo(Iterable<T> i, T... objs) {
    HashSet<T> hs1 = new HashSet<>();
    HashSet<T> hs2 = new HashSet<>();
  ...
  public static void testGenericGraph(iGraph<Character> G) {
    try {
      ...
      Autograder.Log("Finished graph test for " + G + System.lineSeparator());
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public static void main(String[] args) {
    ...
    DirectedUnweightedGraph<Character> duG = new DirectedUnweightedGraph<>();
    if (duG.isDirected())
      Autograder.addGrade(0.25f);
    else
    ...
    UndirectedWeightedGraph<Character> uwG = new UndirectedWeightedGraph<>();
    if (!uwG.isDirected())
      Autograder.addGrade(0.25f);
    else
    ...
    DirectedWeightedGraph<Character> dwG = new DirectedWeightedGraph<>();
    if (dwG.isDirected())
      Autograder.addGrade(0.25f);
    else
      Autograder.Log("Directed graph returning undirected");
    ...
    Autograder.setGrade((float)((Autograder.getGrade() / 35.75) * 47.0));
